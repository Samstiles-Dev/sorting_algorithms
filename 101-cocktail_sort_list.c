#include "sort.h"
/**
*swap - Exchange 2 nodes within a doubly-linked list.
...
/**
*tail_traverse- Function sorting from tail to head.
*
*@head: head of list
...
/**
*cocktail_sort_list - sorts linked list using cocktail shaker sort alg
*
